...
# Operation Component
### Web Pages
 Face Tech has a user interface for users, here they can create a project. Most of these user interface pages are [forms][forms], through these forms user may submit the action like add/update/delete. Many pages also have the same version of APIs, like create a group, user may use user interface or call API to do this, for this kind of function we will cover it in APIs.
 ...
 * [create_group][create a group]
  Params follow the format of [group form][group form], it has to submit with project id and security key.
