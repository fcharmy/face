...
# Implementation
 ...
 To start server when reboot, make sure Nginx is working, then excute step 10 in [IMPLEMENT.md](https://github.com/fcharmy/face/blob/master/face_web/IMPLEMENT.md).
