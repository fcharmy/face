...
And make SURE the python environment triggered by `uwsgi` is congruous with the environment you develop Django project, especially you are using conda or virtualenv.
